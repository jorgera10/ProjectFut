...
public class prueba extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbEquiposDisponibles.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    private void cmbEquiposDisponiblesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbEquiposDisponiblesActionPerformed
        ...
        ls.add("jorge1");
        ls.add("jorge2");
        cmbEquiposDisponibles.setModel(new DefaultComboBoxModel(ls.toArray()));
